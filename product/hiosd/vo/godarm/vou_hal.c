...
HI_U32 HAL_Conver_CscCoef(HI_S32 s32Value)
{
    ...
    /* ��������! ��CSC�����������Ľ��s32Value��-1��-2��ֵʱ��
    *   s32Result����0�����仰˵0.001ת���ɶ�������0x0000 0000 01
    *   ��ע�͵��Ĵ�����㣬��Ĵ�����ֵ��0x1000�����ֵ�ᵼ��ͼ��Ϊ��ɫ(50 2 50 50)
    */
    if (s32Result < 0)
    //if (s32Value < 0)
    {
...
HI_BOOL HAL_DISP_SetBt656MuxHdSel(HAL_DISP_OUTPUTCHANNEL_E enChan)
{
    ...
    switch(enChan)
    {
        ...
        {
            VOMUX.u32 = HAL_ReadReg((HI_U32*)&(pVoReg->VOMUX.u32));
            VOMUX.bits.bt656_mux_hd = 0;//����ѡ��BT1120���
            HAL_WriteReg((HI_U32*)&(pVoReg->VOMUX.u32), VOMUX.u32); 
        ...
        {
            VOMUX.u32 = HAL_ReadReg((HI_U32*)&(pVoReg->VOMUX.u32));
            VOMUX.bits.bt656_mux_hd = 1;//BT1120�ܽ�ѡ���������BT656�ź�
            HAL_WriteReg((HI_U32*)&(pVoReg->VOMUX.u32), VOMUX.u32); 
    ...
    if (HI_TRUE == bBt656H)
    {
        switch(enChan)
        {
            case HAL_DISP_CHANNEL_DSD0:
            {
                ...
                VOMUX.bits.bt656_sel_yc = 0;//����BT1120��8λ��������bt656���ݣ�0�����ӵ�sd0
                HAL_WriteReg((HI_U32*)&(pVoReg->VOMUX.u32), VOMUX.u32); 
            ...
            {
                VOMUX.u32 = HAL_ReadReg((HI_U32*)&(pVoReg->VOMUX.u32));
                VOMUX.bits.bt656_sel_yc = 1;//����BT1120��8λ��������bt656���ݣ� 1�����ӵ�sd1
                HAL_WriteReg((HI_U32*)&(pVoReg->VOMUX.u32), VOMUX.u32); 
    ...
    else
    {
        switch(enChan)
        {
            case HAL_DISP_CHANNEL_DSD0:
            {
                ...
                VOMUX.bits.bt656_sel_yc = 1;//����BT1120��8λ��������bt656���ݣ�1�����ӵ�sd0
                HAL_WriteReg((HI_U32*)&(pVoReg->VOMUX.u32), VOMUX.u32); 
            ...
            {
                VOMUX.u32 = HAL_ReadReg((HI_U32*)&(pVoReg->VOMUX.u32));
                VOMUX.bits.bt656_sel_yc = 0;//����BT1120��8λ��������bt656���ݣ� 0�����ӵ�sd1
                HAL_WriteReg((HI_U32*)&(pVoReg->VOMUX.u32), VOMUX.u32); 
