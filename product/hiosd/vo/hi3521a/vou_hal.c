...
HI_U32 Vou_GetAbsAddr(HAL_DISP_LAYER_E enLayer, HI_U32 pReg)
{
    ...
    switch(enLayer)
    {
        ...
        {
            RegAbsAddr = (pReg) + 3 * VHD_REG_LEN;//��VHD0��ʼӳ�䣬VSD0���Ϊ����㣬�൱��3531��VHD2
            break;
        }
        case HAL_DISP_LAYER_VP:
        {
            RegAbsAddr = (pReg) + 1 * VHD_REG_LEN;//��VHD0��ʼӳ�䣬VSD0���Ϊ����㣬�൱��3531��VHD2
            break;
        }        
...
HI_BOOL HAL_DISP_SetIntfDataFmt(HAL_DISP_INTF_E enIntf)
{
    ...
    INTF_CTRL.bits.hdmi_mode = 0; /* YUV��ʽ */
...
/*3535ֻҪ����hdmi�Ľӿڣ���hdmiֻ�ܰ���INTF���棬 CVBS��ǯλ�̶��ڱ���ͨ���ϣ���3535û��ǯλֻ�ܿ���*/
...
/*������ķֱ���ֻҪ���ÿ�ȼ��ɣ��߶��Ѿ�����ʾ��ԭʼλ�ú��յ�λ�ã�strideȷ��*/
