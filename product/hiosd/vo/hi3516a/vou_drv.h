...
{
    VOU_ACM_BLKINFO_S stAcmBlk[4];  // 4���ֵ�ĺ���ʱ��������vou_chn.c��
} VOU_ACM_S;
...
{
    VOU_DEV_TYPE_E  enVoDevType;             /* VO�豸���� */
    HI_BOOL         bHdVpssRciv;             /* ����ͼ������Ƿ���Ҫͨ��VPSS���� */
    HI_BOOL         bSdTdeDisp;              /* ��ʾͼ������Ƿ���Ҫͨ��TDEƴ�� */
    HI_BOOL         bSupportWbc;             /* ����֧��wbc���� */
    HI_BOOL         bSptGetScreenFrm;        /* �Ƿ�֧�ֻ�ȡ��Ļ�ӿ� */
} VOU_DEV_CAPABILITY_S;

/* ��Dev��LAYER��ö�ٷ��ڴ˴���Ϊ�˲���mkp��Ĵ���ֱ��ʹ��ö�ٱ�����������ͨ��������Ӧ���������ӿ���ʵ�� */
/* vou device enumeration */
/* ������ʾͨ·ö�٣���Ҫ��HAL�����ʾͨ·ö��һһ��Ӧ */
...
typedef enum
{
    ...
    VOU_SW_LAYER_VHD1  = 1,    
    VOU_SW_LAYER_VP    = 2,
    //VOU_SW_LAYER_VHD2  = 2,     /* ��ʱ��������ϣ�HD2��SD5һ�£���Ӳ�����Ա���һ�£��Ժ��ٸ� */
    VOU_SW_LAYER_VSD0  = 3,
    //VOU_SW_LAYER_VSD1  = 2,
    //VOU_SW_LAYER_VSD2  = 5,
    //VOU_SW_LAYER_VSD3  = 6,
